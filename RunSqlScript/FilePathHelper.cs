...
namespace RunSqlScript
{
    public static class FilePathHelper
    {
        ...
        public static string[] GetRelativePaths(string[] filePaths)
        {
            return GetRelativePaths(filePaths, GetCurrentDirectory());
        }

        public static string[] GetRelativePaths(string[] filePaths, string folder)
        {
        ...
        public static string GetAbsolutePath(string filePath)
        {
            ...
            return GetAbsolutePath(filePath, currentPath);
        }
